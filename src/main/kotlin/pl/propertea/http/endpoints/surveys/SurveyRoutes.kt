...
import pl.propertea.http.endpoints.surveys.changeSurveyStateHandler
import pl.propertea.http.endpoints.surveys.createSurveyHandler
import pl.propertea.http.endpoints.surveys.getSurveyHandler
import pl.propertea.http.endpoints.surveys.getSurveysHandler
import pl.propertea.http.endpoints.surveys.voteSurveyHandler
import pl.propertea.http.parameters.communityId
import pl.propertea.http.parameters.surveyId
