        ...
        override fun createBuilding(
            ...
            if (building == null) {
                BuildingsTable.insert { buildingTable ->
                    ...
                    buildingTable[BuildingsTable.usableArea] = usableArea
                }
            }
...
data class BuildingInsertion(val building: Building, val pass: String, val communities: List<Pair<CommunityId, UsableArea>>)
